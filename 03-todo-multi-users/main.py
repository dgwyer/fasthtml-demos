...
def get(auth):
    ...
    return Title(title), Div('Hello', cls="test"), Div('Hello', cls="test1"), Container(top, card)
...
# Todo:
# - Be able to disable any of the servers
# - Maybe just mirror server() unless you specify the servers to run. i.e. opt in.
# - Test to see if the re. Python libraries are installed. If not, prompt to install.
def serve_dev(db_path='data/utodos.db', sqlite_port=8090, jupyter_port=8091, tw_src='./src/app.css', tw_dist='./public/app.css'):
